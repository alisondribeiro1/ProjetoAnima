<template>
    <!-- component -->
<!-- component -->
<div class="j ustify-end px-12">
  <!-- Cursos -->
  <div class="ml-6 flex w-16 flex-col items-center space-y-10">
    <div class=" rounded-md bg-white p-4 text-blue-600">
...
<!-- Menu secundario -->
    <div class="space-y-48 rounded-md bg-white">
      <ul>
        <!-- Menu secundario - Pagamentos e mensalidades -->
        <li class="p-5">
    ...
    <!--Sair / deslogar da plataforma -->
    <div class="flex items-center justify-center pb-5 rounded-md bg-white p-4 text-blue-600" @click="this.clearToken();">
